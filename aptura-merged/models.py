...
class User(Base):
    ...
    screenings_used_this_month = Column(Integer, default=0)
...
class Payment(Base):
    """Tracks manual bank-transfer payments for premium upgrades."""
...
class PasswordResetOTP(Base):
    """One-time password reset codes sent by email. Codes are stored hashed and expire quickly."""
